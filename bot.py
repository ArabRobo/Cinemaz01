...
from config import API_HASH, APP_ID, LOGGER, TG_BOT_TOKEN, TG_BOT_WORKERS, FORCESUB_CHANNEL, FORCESUB_CHANNEL2, FORCESUB_CHANNEL3, CHANNEL_ID
    ...
    async def start(self):
        ...
        if FORCESUB_CHANNEL:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/SiArab_Support for support")
                sys.exit()
